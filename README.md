...
В данном проекте разработана стандартная библиотека math.h на языке программирования Си. Эта библиотека реализует базовые математические операции, которые затем используются в различных алгоритмах.
...
### Обзор некоторых реализованных функций "math.h"
...
- Реализовано полное покрытие unit-тестами функций библиотеки c помощью библиотеки Check, которые проверяют результаты работы реализации путём сравнения ее с реализацией стандартной библиотеки math.h, и покрывают более 80% кода.
