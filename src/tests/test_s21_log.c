...
START_TEST(log_17) {
  long double asd = s21_log(9.234578353457e-6);
  long double qwe = log(9.234578353457e-6);
  ck_assert_ldouble_eq_tol(asd, qwe, 1e-6);
}
END_TEST

START_TEST(log_18) {
  long double asd = s21_log(9.234578353457e6);
  long double qwe = log(9.234578353457e6);
  ck_assert_ldouble_eq_tol(asd, qwe, 1e-6);
}
END_TEST
